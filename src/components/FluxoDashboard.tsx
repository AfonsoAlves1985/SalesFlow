...
export default function FluxoDashboard({ products, comandas, receivables = [], onUpdateReceivable, stockMovements, setStockMovements, activeShift, shiftHistory = [] }: Props) {
  ...
  return (
    <div className="space-y-4 lg:space-y-6 animate-fadeIn min-w-0">
      {/* Header */}
      <div className="bg-white p-4 sm:p-6 rounded-2xl border border-slate-100 shadow-sm min-w-0">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
          ...
          <div className="sf-fluid-actions sm:flex-row">
        ...
        {/* Date Range */}
        <div className="grid grid-cols-1 sm:grid-cols-[auto_auto_auto_1fr] gap-3 items-center">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <input
              ...
              className="w-full px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:outline-none focus:border-frz-primary"
            />
          </div>
      ...
      <div className="bg-white p-4 sm:p-6 rounded-2xl border border-slate-100 shadow-sm min-w-0">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_auto] gap-3 sm:items-end w-full lg:w-auto">
            <div>
              ...
              <select
                ...
                className="w-full sm:min-w-[240px] px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:outline-none focus:border-frz-primary"
              >
            ...
            <div className="sf-fluid-actions sm:flex-row sm:flex-nowrap">
        ...
        <div className="sf-table-scroll max-h-[280px] overflow-y-auto mt-4 border border-slate-100 rounded-xl">
          <table className="sf-table-compact w-full text-xs">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-2xl border border-slate-100 shadow-sm min-w-0">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[auto_minmax(0,1fr)_auto] gap-3 sm:items-end w-full lg:w-auto">
            <div>
              ...
              <select
                ...
                className="w-full sm:min-w-[150px] px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:outline-none focus:border-frz-primary"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full sm:min-w-[220px] px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 placeholder:text-slate-500 focus:outline-none focus:border-frz-primary"
              />
            </div>
        ...
        <div className="sf-table-scroll max-h-[360px] overflow-y-auto mt-4 border border-slate-100 rounded-xl">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="sf-table-scroll max-h-[360px] overflow-y-auto">
          <table className="sf-table w-full text-xs">
            <thead className="bg-slate-50 sticky top-0">
              <tr>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="sf-table-scroll max-h-[500px] overflow-y-auto">
          <table className="sf-table w-full text-xs">
            <thead className="bg-slate-50 sticky top-0">
              <tr>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="sf-table-scroll max-h-[400px] overflow-y-auto">
          <table className="sf-table-compact w-full text-xs">
            <thead className="bg-slate-50 sticky top-0">
              <tr>
