...
import { Package, Plus, Edit2, Trash2, Search, CheckCircle2, AlertTriangle, RefreshCw, Tag } from 'lucide-react';
      ...
      <div className="p-6 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50/50">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 bg-[#C5A059] hover:bg-[#B38F4B] text-black border border-[#B38F4B]/30 rounded-xl text-xs font-extrabold transition cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 bg-[#C5A059] hover:bg-[#B38F4B] text-black rounded-xl text-xs font-extrabold transition shadow-sm cursor-pointer"
          >
          ...
          <div className="mb-6 p-5 border border-indigo-100 bg-indigo-50/30 rounded-xl animate-fadeIn">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="md:col-span-2 lg:col-span-5 flex justify-end gap-2 mt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-1.5 bg-[#C5A059] hover:bg-[#B38F4B] text-black rounded-lg text-xs font-extrabold transition flex items-center gap-1.5 shadow-sm cursor-pointer"
                >
          ...
          >
            ...
            <div className="p-5 space-y-4">
              ...
              <form onSubmit={handleAddCategory} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="px-3.5 py-2 bg-[#C5A059] hover:bg-[#B38F4B] text-black rounded-xl text-xs font-black transition cursor-pointer flex items-center gap-1 shrink-0"
                >
